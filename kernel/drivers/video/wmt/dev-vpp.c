	...
	if( !write ){
		switch( ctl->ctl_name ){
			...
			case 24:
				...
				break;
			case 25:
				vpp_proc_value = g_vpp.hdmi_hdcp_enable;
#ifdef WMT_FTBLK_HDMI			
				{
					extern void hdmi_hdcp_init(void);
					hdmi_hdcp_init();
				}
#endif
				break;
	...
	if( write ){
		switch( ctl->ctl_name ){
			...
			case 25:
				{
#ifdef WMT_FTBLK_HDMI
				hdmi_set_HDCP_enable(vpp_proc_value);
#endif				
				g_vpp.hdmi_hdcp_enable = vpp_proc_value;
				}
				break;
			case 26:
